...
* **Installable:** Dapat diinstal ke *homescreen* perangkat *mobile* maupun *desktop* layaknya aplikasi native.
...
Desain antarmuka yang bersih dan responsif (*Mobile-First Approach*) menggunakan CSS modern, menjamin kenyamanan pengguna di berbagai ukuran layar.

---

## 🛠️ Teknologi yang Digunakan

Proyek ini dibangun menggunakan arsitektur *Client-Server* (Separation of Concerns).
